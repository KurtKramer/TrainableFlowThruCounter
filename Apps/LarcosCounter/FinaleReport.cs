...
namespace LarcosCounter
{
  public partial class FinaleReport : Form
  {
    ...
    private  UmiParticleEntryList  LoadParticlesFromSky8Trip ()
    {
      String[]  fileNames = {"F:\\Larcos\\ScannerFiles\\2014-06-18_Sky8\\2014-06-18_PV-_524\\PV-_524_20140618-113432.lsc",
                             "F:\\Larcos\\ScannerFiles\\2014-06-18_Sky8\\2014-06-18_PV-_525\\PV-_525_20140618-120104.lsc",
                             "F:\\Larcos\\ScannerFiles\\2014-06-18_Sky8\\2014-06-18_PV-_526\\PV-_526_20140618-122334.lsc"
                            };

      UmiParticleEntryList  p = UmiParticleEntryList.LoadMultipleScannerFiles (fileNames, runLog);
      return  p;
    }
                                   ...
                                   )
    {
      ...
      try
      {
        ...
        FinaleReportDataSourceBindingSource.DataSource = typeof (global::LarcosCounter.FinaleReportDataSource);
        ...
        reportViewer1.LocalReport.ReportEmbeddedResource = "LarcosCounter.LarcosSessionReport.rdlc";
