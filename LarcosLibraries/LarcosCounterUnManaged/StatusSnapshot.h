...
namespace LarcosCounterUnManaged
{
  ...
  public:
    ...
    /**
     *@brief  Will assign the change(difference) between two successive 'LarcosCounterStats'. 
     *@details This is meant to look for what has changed in the counters status since the last 
     * call to LarcosCounterManager::GetStats. For example the call to "GetStats" will return the total
     * number of dropped frames; but what we are interested in is whether frames are still being dropped.
     */
    void  Assign (const LarcosCounterStats&  _lastEntry,
  ...
  /**
   *@brief  Used by "LarcosCounterManager" and  "StatusSnapshotThread"  to keep track of snapshots of Counter Status at defined intervals of time.
