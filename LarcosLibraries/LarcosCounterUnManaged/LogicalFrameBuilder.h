...
namespace LarcosCounterUnManaged
{
   ...
   *         then the the scan-line with the least number of foreground pixels will be selected as a breaking point
   *         for the logical frame.
   */
  class LogicalFrameBuilder:  public  CameraThread
  {
  public:
    LogicalFrameBuilder (LarcosCounterManagerPtr   _manager,
  ...
  private:
    ...
    LogicalFrameEntryListPtr  logicalFrameEntries;         /**< All Logical Frames will have an entry in this list. Owned by 'LarcosCounterManager' */
    LogicalFrameEntryQueuePtr droppedFrames;               /**< Whatever logical frames have to be dropped will have an entry added to this queue.  Owned by 'LarcosCounterManager'    */
