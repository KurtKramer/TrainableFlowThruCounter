...
{
  /**
   *@brief  This thread will manage all RunLog activity for the LarcosCounterManager.
   *@details  .
   */
  ...
  private:
    ...
    ofstream*    logFile;
    KKStr        logFileName;
    MsgQueuePtr  loggedMsgs;  /**< Will contain messages that have already been written to 'logFile' but have not been sent on to owner of 'LarcosCounterManager'. */
