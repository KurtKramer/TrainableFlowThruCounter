...
CameraAcquisition::CameraAcquisition (LarcosCounterManagerPtr _manager,
...
{
  const LarcosCounterManagerPtr  manager = ManagerConst ();
...
void  CameraAcquisition::GetStats (LarcosCounterStats&  larcosCameraStats) const
{
