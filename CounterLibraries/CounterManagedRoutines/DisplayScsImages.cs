...
{
  public partial class DisplayScsImages : Form
  {
    private  String                dir;
    ...
    public DisplayScsImages (String  _dir)
    {
      InitializeComponent ();
      
      dir = UmiOSservices.AddSlash (_dir);
      Text = dir;
                            ...
                            )
    {
      ...
      dir  = UmiOSservices.AddSlash (_dir);
      dir2 = UmiOSservices.AddSlash (_dir2);
      ...
      if  (!String.IsNullOrEmpty (dir)  &&  !String.IsNullOrEmpty (dir2))
        Text = UmiOSservices.GetRootNameOfDirectory (dir) + " vs " + UmiOSservices.GetRootNameOfDirectory (dir2);
    ...
    private  void  LoadNextImageFromDir ()
    {
      ...
      String  rootName = UmiOSservices.GetRootName (fi.Name);
    ...
    private  String  LocateRootName (String  rootName)
    {
      ...
      if  (!String.IsNullOrEmpty (dir))
        subDir = UmiOSservices.LookForFile (rootName + ".bmp", dir);

      if  (String.IsNullOrEmpty (subDir))
      {
        if  (!String.IsNullOrEmpty (dir2))
        {
          subDir = UmiOSservices.LookForFile (rootName + ".bmp", dir2);
          if  (subDir == null)
            return  null;
        }
      } 

      return  UmiOSservices.AddSlash (subDir) + rootName + ".bmp";
    }  /* LocateRootName */
    ...
    private  void  LoadNextImageFromNameList ()
    {
      ...
      String  subDir = UmiOSservices.GetPathPartOfFile (fullName);
      ...
      tb = new TextBox ();
      tb.Width = pan.Width - 8;
      tb.Text = UmiOSservices.GetRootNameOfDirectory (subDir);
      tb.Font = font;
      pan.Controls.Add (tb);
    ...
    private  void  ThumbNail_MouseDoubleClick (object sender, MouseEventArgs e)
    {
      if  (e.Button == MouseButtons.Left)
      {
        ...
        UmiRaster  pr = new UmiRaster (imageFileName);
    ...
    private void DisplayScsImages_ResizeEnd(object sender, EventArgs e)
    {
