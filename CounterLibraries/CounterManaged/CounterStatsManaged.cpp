...
CounterStatsManaged::CounterStatsManaged (CounterStatsPtr  stats):
    bytesWritten                    (0),
...
CounterStatsManaged::!CounterStatsManaged ()
{
  CleanUpMemory ();
}
...
CounterStatsManaged::~CounterStatsManaged ()
{
  this->!CounterStatsManaged ();
}


void  CounterStatsManaged::CleanUpMemory ()
{
}
