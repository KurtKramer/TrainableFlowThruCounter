...
kkuint32  CounterFVProducer::maxNumOfFeatures     = 56;

kkint16  CounterFVProducer::SizeIndex             = 0;
kkint16  CounterFVProducer::Moment1Index          = 1;
kkint16  CounterFVProducer::Moment2Index          = 2;
kkint16  CounterFVProducer::Moment3Index          = 3;
kkint16  CounterFVProducer::Moment4Index          = 4;
kkint16  CounterFVProducer::Moment5Index          = 5;
kkint16  CounterFVProducer::Moment6Index          = 6;
kkint16  CounterFVProducer::Moment7Index          = 7;
kkint16  CounterFVProducer::Moment8Index          = 8;

kkint16  CounterFVProducer::EdgeSizeIndex         = 9;
kkint16  CounterFVProducer::EdgeMoment1Index      = 10;
kkint16  CounterFVProducer::EdgeMoment2Index      = 11;	
kkint16  CounterFVProducer::EdgeMoment3Index      = 12;
kkint16  CounterFVProducer::EdgeMoment4Index      = 13;
kkint16  CounterFVProducer::EdgeMoment5Index      = 14;
kkint16  CounterFVProducer::EdgeMoment6Index      = 15;
kkint16  CounterFVProducer::EdgeMoment7Index      = 16;
kkint16  CounterFVProducer::EdgeMoment8Index      = 17;

kkint16  CounterFVProducer::TransparancyConvexHullIndex = 18;
kkint16  CounterFVProducer::TransparancyPixelCountIndex = 19;
kkint16  CounterFVProducer::TransparancyOpen3Index      = 20;
kkint16  CounterFVProducer::TransparancyOpen5Index      = 21;
kkint16  CounterFVProducer::TransparancyOpen7Index      = 22;
kkint16  CounterFVProducer::TransparancyOpen9Index      = 23;
kkint16  CounterFVProducer::TransparancyClose3Index     = 24;
kkint16  CounterFVProducer::TransparancyClose5Index     = 25;
kkint16  CounterFVProducer::TransparancyClose7Index     = 26;

kkint16  CounterFVProducer::ConvexAreaIndex       = 27;
kkint16  CounterFVProducer::TransparancySizeIndex = 28;
kkint16  CounterFVProducer::TransparancyWtdIndex  = 29;
kkint16  CounterFVProducer::WeighedMoment0Index   = 30;
kkint16  CounterFVProducer::WeighedMoment1Index   = 31;
kkint16  CounterFVProducer::WeighedMoment2Index   = 32;
kkint16  CounterFVProducer::WeighedMoment3Index   = 33;
kkint16  CounterFVProducer::WeighedMoment4Index   = 34;
kkint16  CounterFVProducer::WeighedMoment5Index   = 35;
kkint16  CounterFVProducer::WeighedMoment6Index   = 36;
kkint16  CounterFVProducer::WeighedMoment7Index   = 37;
kkint16  CounterFVProducer::WeighedMoment8Index   = 38;

kkint16  CounterFVProducer::IntensityHist1Index   = 39;
kkint16  CounterFVProducer::IntensityHist2Index   = 40;
kkint16  CounterFVProducer::IntensityHist3Index   = 41;
kkint16  CounterFVProducer::IntensityHist4Index   = 42;
kkint16  CounterFVProducer::IntensityHist5Index   = 43;
kkint16  CounterFVProducer::IntensityHist6Index   = 44;
kkint16  CounterFVProducer::IntensityHist7Index   = 45;

kkint16  CounterFVProducer::DarkSpotCount0        = 46;
kkint16  CounterFVProducer::DarkSpotCount1        = 47;
kkint16  CounterFVProducer::DarkSpotCount2        = 48;
kkint16  CounterFVProducer::DarkSpotCount3        = 49;
kkint16  CounterFVProducer::DarkSpotCount4        = 50;
kkint16  CounterFVProducer::DarkSpotCount5        = 51;
kkint16  CounterFVProducer::DarkSpotCount6        = 52;
kkint16  CounterFVProducer::DarkSpotCount7        = 53;
kkint16  CounterFVProducer::DarkSpotCount8        = 54;
kkint16  CounterFVProducer::DarkSpotCount9        = 55;


const  KKStr  CounterFVProducer::featureNames[] =
{
  "Size",                    //  0
  "Moment1",                 //  1 
  "Moment2",                 //  2
...
CounterFVProducer::CounterFVProducer (FactoryFVProducerPtr  factory):
    FeatureVectorProducer ("CounterFVProducer",
                           factory
                          ),
...
CounterFVProducer::~CounterFVProducer ()
{
...
void  CounterFVProducer::ReductionByMultiple (kkint32        multiple,
...
void  CounterFVProducer::SaveIntermediateImage (const Raster&  raster, 
                                               const KKStr&   desc,
...
void  CounterFVProducer::BinarizeImageByThreshold (uchar          lower,
                                                  uchar          upper,
                                                  const Raster&  src,
                                                  Raster&        dest
                                                 )
                                                               ...
                                                               )
{
  ...
  if  (reductionMultiple > 1)
  {
    ...
    {
      runLog.Level (-1) << endl << "CounterFVProducer::ComputeFeatureVector   ***ERROR***  Exception calling 'ReductionByMultiple'."  << endl << endl;
      return NULL;
    }
...
const type_info*   CounterFVProducer::FeatureVectorTypeId () const
{
...
FileDescConstPtr  CounterFVProducer::DefineFileDesc ()  const
{
...
FileDescConstPtr  CounterFVProducer::existingFileDesc = NULL;

FileDescConstPtr  CounterFVProducer::DefineFileDescStatic ()
{
  if  (existingFileDesc)
