 ...
 * For conditions of distribution and use, see copyright notice in CounterUnManaged.h
 */
...
void  LogicalFrameProcessor::LoadClassifer ()
{
  ...
  else
  {
    ...
    // Since the 'CounterManager' has already built and saved this classifier we already know 
